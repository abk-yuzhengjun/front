  ...
  <div style="width:100%;display: flex;align-items: center;justify-content: center">
    <el-form ref="form" :model="form" label-width="200px">
      <el-form-item label="所属案件：" class="grid-case-ascription">
        <el-select v-model="case_info.case" class="grid-case-ascription-options"
      ...
      <el-form-item label="设备列表：" class="grid-case-ascription">
        <el-select v-model="form.task_info.dev_list" multiple placeholder="请选择" class="grid-device-manage" value="">
          <el-option
    ...
    export default {
        ...
        methods: {
            ...
            submitData() {
                ...
                this.form.task_info.user_id = this.case_info.user_id
            ...
            blackList() {
                ...
                if (1 === this.form.task_info.task_type  && 1 === this.form.task_info.number_content.capture_mode ) {
